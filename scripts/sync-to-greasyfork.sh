...
JS_FILE="$REPO_DIR/LINUXDO_ReadBoost.js"
...
echo "    1. 打开 https://greasyfork.org/scripts/519843-linuxdo-readboost"
echo "    2. 进入 Advanced → Update script from URL"
echo "    3. 填入:"
echo "       https://raw.githubusercontent.com/VKKKV/discourse-read-boost/main/LINUXDO_ReadBoost.js"
echo "    4. 点击 Update"
echo ""
echo "  或手动上传新版本:"
echo "    1. 下载: curl -LO https://raw.githubusercontent.com/VKKKV/discourse-read-boost/main/LINUXDO_ReadBoost.js"
